  ...
  public static class ReactorResourceFactoryConfiguration {
    ...
    private static BeanInstanceSupplier<ReactorResourceFactory> getReactorResourceFactoryInstanceSupplier(
      ...
      return BeanInstanceSupplier.<ReactorResourceFactory>forFactoryMethod(ReactorNettyConfigurations.ReactorResourceFactoryConfiguration.class, "reactorResourceFactory", ReactorNettyProperties.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.reactor.netty.autoconfigure.ReactorNettyConfigurations$ReactorResourceFactoryConfiguration", ReactorNettyConfigurations.ReactorResourceFactoryConfiguration.class).reactorResourceFactory(args.get(0)));
    }
    ...
    public static BeanDefinition getReactorResourceFactoryBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.reactor.netty.autoconfigure.ReactorNettyConfigurations$ReactorResourceFactoryConfiguration");
