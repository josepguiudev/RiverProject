...
/**
 * Bean definitions for {@link RespuestaRepository}.
 */
@Generated
public class RespuestaRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'respuestaRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getRespuestaRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'respuestaRepository'.
   */
  public static BeanDefinition getRespuestaRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, RespuestaRepository.class, Respuesta.class, Long.class));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.equipo.backend.repository.RespuestaRepositoryImpl__AotRepository(entityManager, context));
      }
    });
