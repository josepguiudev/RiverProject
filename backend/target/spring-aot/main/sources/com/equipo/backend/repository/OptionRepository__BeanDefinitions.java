...
/**
 * Bean definitions for {@link OptionRepository}.
 */
@Generated
public class OptionRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'optionRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getOptionRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'optionRepository'.
   */
  public static BeanDefinition getOptionRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, OptionRepository.class, Option.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.equipo.backend.repository.OptionRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.OptionRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.equipo.backend.repository.OptionRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getOptionRepositoryInstanceSupplier();
