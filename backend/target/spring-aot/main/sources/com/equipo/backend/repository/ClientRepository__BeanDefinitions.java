...
/**
 * Bean definitions for {@link ClientRepository}.
 */
@Generated
public class ClientRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'clientRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getClientRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'clientRepository'.
   */
  public static BeanDefinition getClientRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ClientRepository.class, Client.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.equipo.backend.repository.ClientRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ClientRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.equipo.backend.repository.ClientRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getClientRepositoryInstanceSupplier();
