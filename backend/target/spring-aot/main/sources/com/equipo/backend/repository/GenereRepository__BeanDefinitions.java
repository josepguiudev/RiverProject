...
/**
 * Bean definitions for {@link GenereRepository}.
 */
@Generated
public class GenereRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'genereRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getGenereRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'genereRepository'.
   */
  public static BeanDefinition getGenereRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, GenereRepository.class, Genere.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.equipo.backend.repository.GenereRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.GenereRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.equipo.backend.repository.GenereRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getGenereRepositoryInstanceSupplier();
