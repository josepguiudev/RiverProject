      ...
      try {
        ...
        if (!profileJson) {
          profileJson = {
            ...
            profileUrl: "https://steamcommunity.com/profiles/76561198166329657",
          };
        }
    ...
    if (user?.id) {
      if (user.role === "CLIENT") {
        ...
        if (!updateRes.ok) {
          const errData = await updateRes.json().catch(() => ({}));
          throw new Error(
            errData.error || "Error al actualizar los datos del usuario.",
          );
        }
      }
    }
      ...
      <View style={styles.tabBar}>
        ...
        >
          <Text
            style={[
              styles.tabText,
              activeTab === "configuracion" && styles.tabTextActive,
            ]}
          >
            Configuración
          </Text>
        ...
        >
          {user?.role === "PLAYER" ? (
            <>
              ...
              >
                <View
                  style={isMobileView ? styles.fullWidth : styles.halfWidth}
                >
                  <DonutGenresCard
            ...
            <View style={{ alignItems: "center", marginTop: 50 }}>
              ...
              >
                ...
                <Text style={{ color: "#888", fontSize: 16, marginBottom: 20 }}>
                  Rol:{" "}
                  <Text style={{ color: "#5b55c0", fontWeight: "bold" }}>
                    {user?.role}
                  </Text>
                </Text>
                <View
                ...
                <Text style={{ color: "#ccc", textAlign: "center" }}>
                  Estás en tu perfil de gestión. Puedes editar tus datos en la
