  ...
  const loadUsers = async (newPage: number) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/api/usersteam/allUsers?page=${newPage}&size=20`,
      );
  ...
  const UserCard = ({ user }: { user: UserBD }) => {
    ...
    return (
      ...
      >
        ...
        >
          <Text style={{ color: "#66c0f4", fontSize: 18, fontWeight: "bold" }}>
            ⋮
          </Text>
        </TouchableOpacity>
        ...
        {/* AVATAR Y NOMBRE */}
        <View
          style={{ alignItems: "center", marginTop: 15, paddingHorizontal: 5 }}
        >
          <Image
    ...
    >
      ...
      <View
        style={[
          ...
          globalStyles.alineadoPersonalVertical,
          globalStyles.borde2,
          { height: "100%" },
        ]}
      >
      ...
      >
        ...
        >
          ...
          >
            ...
            <View style={{ gap: 15 }}>
              ...
              <View>
                ...
                <TextInput
                  ...
                  value={
                    editingUser ? selectedUser?.avatar : selectedGame?.iconUrl
                  }
            ...
            >
              <Text
                style={{ color: "#889fb2", textDecorationLine: "underline" }}
              >
                Cancelar y salir
              </Text>
            </TouchableOpacity>
