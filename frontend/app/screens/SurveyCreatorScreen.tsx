...
const SurveyCreatorScreen = ({ navigation }: any) => {
    ...
    // ============================================================
    //  VERSIÓN ANDROID (diseño táctil, apilado, legible)
    // ============================================================
    // ============================================================
//  VERSIÓN ANDROID (con botón de publicar visible siempre)
// ============================================================
return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
        ...
        >
            {/* Título */}
            <Text style={{ fontSize: 32, fontWeight: "bold", color: colors.white, marginBottom: 8 }}>
            ...
            {/* ✅ BOTÓN PUBLICAR (aquí, antes del sidebar, más visible) */}
            <TouchableOpacity
                style={{
